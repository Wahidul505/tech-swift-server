...
const getSingleFromDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield product_service_1.ProductService.getSingleFromDB(req.params.id);
    (0, sendResponse_1.default)(res, {
        success: true,
...
const updateFromDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield product_service_1.ProductService.updateFromDB(id, payload);
    (0, sendResponse_1.default)(res, {
        success: true,
...
const deleteFromDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    yield product_service_1.ProductService.deleteFromDB(id);
    (0, sendResponse_1.default)(res, {
        success: true,
